package me.sathish.reactiveproj.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
            "@within(me.sathish.reactiveproj.config.logging.Loggable) || "
                    + "@annotation(me.sathish.reactiveproj.config.logging.Loggable)")
